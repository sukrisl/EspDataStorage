...
static const char* storageDeviceStatusToName(StorageDeviceStatus_t stat) {
    switch (stat) {
        case STORAGE_DEVICE_ONLINE: return "ONLINE";
        case STORAGE_DEVICE_OFFLINE: return "OFFLINE";
        case STORAGE_DEVICE_CORRUPT: return "CORRUPTED";
    }
...
static const char* storageDeviceTypeToName(StorageDeviceType_t type) {
    switch (type) {
        case STORAGE_DEVICE_TYPE_UNKNOWN: return "UNKNOWN";
        case STORAGE_DEVICE_TYPE_FLASH: return "FLASH";
        case STORAGE_DEVICE_TYPE_SD: return "SD";
    }
